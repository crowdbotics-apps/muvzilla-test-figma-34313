...
## Project Structure
    ...
    ├── muvzilla_test_figma_34313  # Django project configurations
...
1. Clone this repo and `cd muvzilla_test_figma_34313`
...
2. Clone this repo and `cd muvzilla_test_figma_34313`
